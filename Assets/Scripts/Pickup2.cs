...
public class Pickup2 : MonoBehaviour
{
    ...
    //    if (Input.GetKeyDown(KeyCode.P) && flagHold && delDis1 < 2f)
    //    {
    //        if (Material[0])
    //        {
    //            Destroy(clone1);
    ...
    //            Material[5] = false;
    //        }
    //    }else if (Input.GetKeyDown(KeyCode.P) && flagHold && delDis2 < 2f)
    //    {
    //        if (Material[0])
    //        {
    //            Destroy(clone1);
    ...
    //            Material[5] = false;
    //        }
    //    }else if (Input.GetKeyDown(KeyCode.P) && flagHold && delDis3 < 2f)
    //    {
    //        if (Material[0])
    //        {
    //            Destroy(clone1);
    ...
    //            Material[5] = false;
    //        }
    //    }else if (Input.GetKeyDown(KeyCode.P) && flagHold && delDis4 < 2f)
    //    {
    //        if (Material[0])
    //        {
    //            Destroy(clone1);
    ...
    //    if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis1 < 2f)
    //    {
    ...
    //    }
    //    else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis2 < 2f)
    //    {
    //        if (clone1 != null) clone1.active = false;
    //        if (clone2 != null) clone2.active = false;
    //        if (clone3 != null) clone3.active = false;
    ...
    //    }
    //    else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis3 < 2f)
    //    {
    //        if (clone1 != null) clone1.active = false;
    //        if (clone2 != null) clone2.active = false;
    //        if (clone3 != null) clone3.active = false;
    ...
    //    }
    //    else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis4 < 2f)
    //    {
    //        if (clone1 != null) clone1.active = false;
    //        if (clone2 != null) clone2.active = false;
    //        if (clone3 != null) clone3.active = false;
    ...
    //    if (Input.GetKeyDown(KeyCode.P) && putDis1 < 1.5f && !exportFlag && !flagHold && p1.materialsCount >= 3)
    //    {
    //        exportHold[0] = true;
    //        exportFlag = true;

    //    }
    //    if (Input.GetKeyDown(KeyCode.P) && putDis2 < 1.5f && !exportFlag && !flagHold && p2.materialsCount >= 3)
    //    {
    //        exportHold[1] = true;
    //        exportFlag = true;

    //    }
    //    if (Input.GetKeyDown(KeyCode.P) && putDis3 < 1.5f && !exportFlag && !flagHold && p3.materialsCount >= 3)
    //    {
    //        exportHold[2] = true;
    //        exportFlag = true;

    //    }
    //    if (Input.GetKeyDown(KeyCode.P) && putDis4 < 1.5f && !exportFlag && !flagHold && p4.materialsCount >= 3)
    //    {
    //        exportHold[3] = true;
    //        exportFlag = true;
    ...
    //    }
    //    if (Input.GetKeyDown(KeyCode.P) && exportFlag && !flagHold && exportDis < 2f)
    //    {
    //        string foodName = "";
    //        if (exportHold[0])
    //        {
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis1 < 2f)
        {
            ...
            if (pick1.temp1 != plate1)
            {
                pick1.temp1.transform.position = new Vector3(100, 200, 100);
            }
            if (p1.materialsCount == 1)
            {
                ...
                {
                    pick1.temp1 = GameObject.Find("Plate_Tomato_Right");
                    pick1.temp1.transform.position = plate1.transform.position;

                }
                else if (p1.plateflag1[1] == true)
                {
                    pick1.temp1 = GameObject.Find("Plate_Cheese_Right");
                    pick1.temp1.transform.position = plate1.transform.position;
                }
                else if (p1.plateflag1[2] == true)
                {
                    pick1.temp1 = GameObject.Find("Plate_Lettuce_Right");
                    pick1.temp1.transform.position = plate1.transform.position;
                }
            ...
            else if (p1.materialsCount == 2)
            {
                ...
                if (p1.plateflag1[0] == true && p1.plateflag1[1] == true)
                {
                    ...
                    pick1.temp1 = GameObject.Find("Plate_Tomato_Cheese_Right");
                    pick1.temp1.transform.position = plate1.transform.position;
                }
                else if (p1.plateflag1[0] == true && p1.plateflag1[2] == true)
                {
                    pick1.temp1 = GameObject.Find("Plate_Tomato_Lettuce_Right");
                    pick1.temp1.transform.position = plate1.transform.position;
                }
                else if (p1.plateflag1[1] == true && p1.plateflag1[2] == true)
                {
                    pick1.temp1 = GameObject.Find("Plate_Cheese_Lettuce_Right");
                    pick1.temp1.transform.position = plate1.transform.position;
                }
            }
            ...
            {
                pick1.temp1.transform.position = new Vector3(100, 200, 100);
                pick1.temp1 = GameObject.Find("Plate_Salad_Right");
                pick1.temp1.transform.position = plate1.transform.position;
            }
        ...
        else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis2 < 2f)
        {
            ...
            if (pick1.temp2 != plate2)
            {
                pick1.temp2.transform.position = new Vector3(100, 200, 100);
            }
            if (p2.materialsCount == 1)
            {
                ...
                {
                    pick1.temp2 = GameObject.Find("Plate_Tomato_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;

                }
                else if (p2.plateflag2[1] == true)
                {
                    pick1.temp2 = GameObject.Find("Plate_Cheese_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;
                }
                else if (p2.plateflag2[2] == true)
                {
                    pick1.temp2 = GameObject.Find("Plate_Lettuce_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;
                }
            ...
            else if (p2.materialsCount == 2)
            {
                ...
                if (p2.plateflag2[0] == true && p2.plateflag2[1] == true)
                {
                    ...
                    pick1.temp2 = GameObject.Find("Plate_Tomato_Cheese_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;
                }
                else if (p2.plateflag2[0] == true && p2.plateflag2[2] == true)
                {
                    pick1.temp2 = GameObject.Find("Plate_Tomato_Lettuce_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;
                }
                else if (p2.plateflag2[1] == true && p2.plateflag2[2] == true)
                {
                    pick1.temp2 = GameObject.Find("Plate_Cheese_Lettuce_Right (1)");
                    pick1.temp2.transform.position = plate2.transform.position;
                }
            }
            ...
            {
                pick1.temp2.transform.position = new Vector3(100, 200, 100);
                pick1.temp2 = GameObject.Find("Plate_Salad_Right (1)");
                pick1.temp2.transform.position = plate2.transform.position;
            }
        ...
        else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis3 < 2f)
        {
            ...
            if (pick1.temp3 != plate3)
            {
                pick1.temp3.transform.position = new Vector3(100, 200, 100);
            }
            if (p3.materialsCount == 1)
            {
                ...
                {
                    pick1.temp3 = GameObject.Find("Plate_Tomato_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;

                }
                else if (p3.plateflag3[1] == true)
                {
                    pick1.temp3 = GameObject.Find("Plate_Cheese_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;
                }
                else if (p3.plateflag3[2] == true)
                {
                    pick1.temp3 = GameObject.Find("Plate_Lettuce_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;
                }
            ...
            else if (p3.materialsCount == 2)
            {
                ...
                if (p3.plateflag3[0] == true && p3.plateflag3[1] == true)
                {
                    ...
                    pick1.temp3 = GameObject.Find("Plate_Tomato_Cheese_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;
                }
                else if (p3.plateflag3[0] == true && p3.plateflag3[2] == true)
                {
                    pick1.temp3 = GameObject.Find("Plate_Tomato_Lettuce_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;
                }
                else if (p3.plateflag3[1] == true && p3.plateflag3[2] == true)
                {
                    pick1.temp3 = GameObject.Find("Plate_Cheese_Lettuce_Right (2)");
                    pick1.temp3.transform.position = plate3.transform.position;
                }
            }
            ...
            {
                pick1.temp3.transform.position = new Vector3(100, 200, 100);
                pick1.temp3 = GameObject.Find("Plate_Salad_Right (2)");
                pick1.temp3.transform.position = plate3.transform.position;
            }
        ...
        else if (Input.GetKeyDown(KeyCode.P) && flagHold && putDis4 < 2f)
        {
            ...
            if (pick1.temp4 != plate4)
            {
                pick1.temp4.transform.position = new Vector3(100, 200, 100);
            }
            if (p4.materialsCount == 1)
            {
                ...
                {
                    pick1.temp4 = GameObject.Find("Plate_Tomato_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;

                }
                else if (p4.plateflag4[1] == true)
                {
                    pick1.temp4 = GameObject.Find("Plate_Cheese_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;
                }
                else if (p4.plateflag4[2] == true)
                {
                    pick1.temp4 = GameObject.Find("Plate_Lettuce_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;
                }
            ...
            else if (p4.materialsCount == 2)
            {
                ...
                if (p4.plateflag4[0] == true && p4.plateflag4[1] == true)
                {
                    ...
                    pick1.temp4 = GameObject.Find("Plate_Tomato_Cheese_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;
                }
                else if (p4.plateflag4[0] == true && p4.plateflag4[2] == true)
                {
                    pick1.temp4 = GameObject.Find("Plate_Tomato_Lettuce_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;
                }
                else if (p4.plateflag4[1] == true && p4.plateflag4[2] == true)
                {
                    pick1.temp4 = GameObject.Find("Plate_Cheese_Lettuce_Right (3)");
                    pick1.temp4.transform.position = plate4.transform.position;
                }
            }
            ...
            {
                pick1.temp4.transform.position = new Vector3(100, 200, 100);
                pick1.temp4 = GameObject.Find("Plate_Salad_Right (3)");
                pick1.temp4.transform.position = plate4.transform.position;
            }
        ...
        if (Input.GetKeyDown(KeyCode.P) && putDis1 < 1.5f && !exportFlag && !flagHold && !exportHold[0] && p1.materialsCount >= 3)
        {
            exportHold[0] = true;
            exportFlag = true;
            p1.resetFlag1();
        ...
        if (exportFlag)
        {
            if (exportHold[0])
            {
                pick1.temp1.transform.position = Vector3.SmoothDamp(pick1.temp1.transform.position, Player.position + new Vector3(0, 2, 0), ref AVelocity, smoothTime);

            }
            else if (exportHold[1])
            {
                pick1.temp2.transform.position = Vector3.SmoothDamp(pick1.temp2.transform.position, Player.position + new Vector3(0, 2, 0), ref AVelocity, smoothTime);
            }
            else if (exportHold[2])
            {
                pick1.temp3.transform.position = Vector3.SmoothDamp(pick1.temp3.transform.position, Player.position + new Vector3(0, 2, 0), ref AVelocity, smoothTime);
            }
            else if (exportHold[3])
            {
                pick1.temp4.transform.position = Vector3.SmoothDamp(pick1.temp4.transform.position, Player.position + new Vector3(0, 2, 0), ref AVelocity, smoothTime);
            }
        ...
        if (Input.GetKeyDown(KeyCode.P) && exportFlag && !flagHold && exportDis < 2f)
        {
            ...
            if (exportHold[0])
            {
                pick1.temp1.transform.position = ExportTable.transform.position;
                exportHold[0] = false;
                foodName = pick1.temp1.name;
                p1.resetCount();
            }
            else if (exportHold[1])
            {
                pick1.temp2.transform.position = ExportTable.transform.position;
                exportHold[1] = false;
                foodName = pick1.temp2.name;
                p2.resetCount2();
            }
            else if (exportHold[2])
            {
                pick1.temp3.transform.position = ExportTable.transform.position;
                exportHold[2] = false;
                foodName = pick1.temp3.name;
                p3.resetCount3();
            }
            else if (exportHold[3])
            {
                pick1.temp4.transform.position = ExportTable.transform.position;
                exportHold[3] = false;
                foodName = pick1.temp4.name;
                p4.resetCount4();
            }
